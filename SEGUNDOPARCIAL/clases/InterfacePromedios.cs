...
namespace SEGUNDOPARCIAL.clases
{
    interface InterfacePromedios
    {
        ...
        /// <summary>
        /// se manda la ArregloDosD fuente y retrona una matiz nueva con los alumnos clasificados por seccion
        /// </summary>
        /// <param name="matriz"></param>
        /// <param name="seccion"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// retorna una ArregloDosD de 2 columnas con el nombre y la sumatoria de las columnas del parcial 1 al 3
        /// </summary>
        /// <param name="matriz"></param>
        /// <returns></returns>
